...
public class ColorAvg {
    ...
    static MagicCircle magicCircle1 = new MagicCircle(9);
    static MagicCircle magicCircle2 = new MagicCircle(2);
    ...
    static Rectangle rectangle3 = new Rectangle(6, 5, Color.BLUE);
    ...
    static Square square2 = new Square(8, Color.RED);
    static Square square3 = new Square(3, Color.BLUE);
    ...
    public static void main(String[] args){
        ...
        for( Shapes shape : shapes){
            ...
            if( shape.getColor() == Color.RED.getCode() ) {
                redcount++; redAvg += shape.area();
            }
            if( shape.getColor() == Color.GREEN.getCode() ) {
                greencount++; greenAvg += shape.area();
            }
            if( shape.getColor() == Color.BLUE.getCode() ) {
                bluecount++; blueAvg += shape.area();
            }
